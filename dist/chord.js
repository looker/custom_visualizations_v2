...
var vis = {
    ...
    create: function (element, config) {
        ...
        this.tooltip = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](element).append('div').attr('class', 'chord-tip');
        this.svg = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](element).append('svg');
    },
    computeMatrix: function (data, dimensions, measure) {
        var indexByName = __WEBPACK_IMPORTED_MODULE_0_d3__["map"]();
        var nameByIndex = __WEBPACK_IMPORTED_MODULE_0_d3__["map"]();
        var matrix = [];
        var n = 0;
    ...
    update: function (data, element, config, queryResponse) {
        ...
        var chord = __WEBPACK_IMPORTED_MODULE_0_d3__["chord"]()
            .padAngle(0.025)
            .sortSubgroups(__WEBPACK_IMPORTED_MODULE_0_d3__["descending"])
            .sortChords(__WEBPACK_IMPORTED_MODULE_0_d3__["descending"]);
        // Create ribbon generator
        var ribbon = __WEBPACK_IMPORTED_MODULE_0_d3__["ribbon"]()
            .radius(innerRadius);
        ...
        var ribbons = svg.append('g')
            ...
            .style('stroke', function (d) { return __WEBPACK_IMPORTED_MODULE_0_d3__["rgb"]('blue').darker(); })
        ...
        var groupPath = group.append('path')
            ...
            .style('stroke', function (d) { return __WEBPACK_IMPORTED_MODULE_0_d3__["rgb"]('red').darker(); })
