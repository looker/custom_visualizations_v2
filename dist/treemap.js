...
var vis = {
    ...
    update: function (data, element, config, queryResponse) {
        ...
        var treemap = __WEBPACK_IMPORTED_MODULE_0_d3__["r" /* treemap */]()
            .size([width, height - 16])
            .tile(__WEBPACK_IMPORTED_MODULE_0_d3__["s" /* treemapSquarify */].ratio(1))
            .paddingOuter(1)
        ...
        var breadcrumb = svg.append('text')
            .attr('y', -5)
            .attr('x', 4);
        var root = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* hierarchy */](burrow(data)).sum(function (d) {
        ...
        cell.append('rect')
            ...
            var scale = __WEBPACK_IMPORTED_MODULE_0_d3__["k" /* scaleLinear */]()
                .domain([1, 6.5])
                .range(colors);
