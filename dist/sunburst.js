...
var vis = {
    ...
    create: function (element, config) {
        this.svg = __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* select */](element).append('svg');
    },
    ...
    update: function (data, element, config, queryResponse) {
        ...
        var x = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* scaleLinear */]().range([0, 2 * Math.PI]);
        var y = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* scaleSqrt */]().range([0, radius]);
        var color = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleOrdinal */]().range(config.color_range);
        ...
        var partition = __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* partition */]().size([2 * Math.PI, radius * radius]);
